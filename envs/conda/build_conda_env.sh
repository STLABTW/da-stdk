...
#
# This script builds a Conda environment based on the provided name or the default 'st-dadk'.
#
# Parameters:
#   -c, --conda_env       Specifies the name of the Conda environment (default: 'st-dadk')
#
# Examples:
#   1. Build the default Conda environment 'st-dadk':
#       ./build_conda_env.sh
#
